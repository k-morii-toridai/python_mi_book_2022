...
def plot_X_withlabel(X_PCA, X_new_PCA, ans_list,
    ...
    sns.kdeplot(x=X_PCA[:, 0], y=X_PCA[:, 1], alpha=0.3)
    ax.scatter(X_PCA[:, 0], X_PCA[:, 1], marker=".", alpha=0.1)
...
def plot_X_clusters(X_PCA, yp_km, alpha=0.1, tickfontsize=15, legendfontsize=15):
    """plot X clusters
